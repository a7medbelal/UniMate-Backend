...
namespace Uni_Mate.Migrations
{
    ...
    [Migration("20250504233634_init3")]
    partial class init3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Uni_Mate.Models.ApartmentManagement.Apartment", b =>
                {
                    ...
                    b.Property<string>("DescripeLocation")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Uni_Mate.Models.ApartmentManagement.ApartmentFacility", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Uni_Mate.Models.ApartmentManagement.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Uni_Mate.Models.ApartmentManagement.Facility", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Uni_Mate.Models.UserManagment.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3ca16141-c8a0-4331-8825-8b4ebbf8a509",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAELxXSEzBVB+MLctwDFjalYRaeYe9z+pU+c/HgFa32WSu+M5wo1mSg9taW4QMW1HHfg==",
                            PhoneNumber = "01040363077",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "b3eea0dc-9449-4a34-a858-af4b8d3adbd4",
            ...
            modelBuilder.Entity("Uni_Mate.Models.ApartmentManagement.ApartmentFacility", b =>
                {
                    ...
                    b.HasOne("Uni_Mate.Models.ApartmentManagement.Facility", "Facility")
                        .WithMany("ApartmentFacilities")
            ...
            modelBuilder.Entity("Uni_Mate.Models.ApartmentManagement.Facility", b =>
                {
                    b.HasOne("Uni_Mate.Models.ApartmentManagement.Category", "FacilityCategory")
                        .WithMany("Facilities")
